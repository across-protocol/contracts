...
use crate::{
    ...
    v5::{
        ...
        pda::{
            derive_fill_status, derive_v5_fill_payer, find_v5_account, require_gateway_dispatch_authority,
            require_v5_delegate_allowance,
        },
    },
};
...
pub fn adapter_execute_across_v5<'info>(
    ...
    match decode_v5_adapter_input(&input)? {
        ...
        V5AdapterInput::FillV1(fill) => execute_v5_fill(ctx, ctx_values, fill, &jit_data),
    }
}
