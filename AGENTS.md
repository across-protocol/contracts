...
1. This file for architecture, build/test commands, naming conventions, test patterns, and code style.
2. `script/utils/CONSTANTS_README.md` and `script/utils/EXTRACT_ADDRESSES.md` for deployment tooling.
3. `script/universal/README.md` for universal SpokePool deployment.
...
- When adding new chain adapters or SpokePool variants, document the chain in both contract comments and deployment scripts.

## Quick index

- EVM contract source: `contracts/`
- Chain adapters: `contracts/chain-adapters/`
- Shared libraries: `contracts/libraries/`
- Interface definitions: `contracts/interfaces/`
- Mock contracts: `contracts/test/`
- Foundry tests (primary): `test/evm/foundry/local/`
- Fork tests: `test/evm/foundry/fork/`
- Test base classes: `test/evm/foundry/utils/`
- Hardhat tests (legacy): `test/evm/hardhat/`
- SVM programs (Rust/Anchor): `programs/`
- SVM tests: `test/svm/`
- Anchor IDLs: `idls/`
- Deployment scripts (Foundry): `script/`
- Deployment utilities: `script/utils/Constants.sol`, `script/utils/DeploymentUtils.sol`
- Universal SpokePool deploy: `script/universal/`
- Storage layouts: `storage-layouts/`
- Foundry deployment receipts: `broadcast/`
- Legacy Hardhat deploys: `deploy/`, `deployments/`
...
contracts/           # Smart contract source files
  chain-adapters/    # L1 chain adapters (30+ adapters)
  interfaces/        # Interface definitions
  libraries/         # Shared libraries (CCTP, OFT, HyperCore)
  periphery/         # Periphery integrations (mintburn, OFT, CCTP)
