...
CONTRACTS=("Universal_SpokePool" "Arbitrum_SpokePool" "Polygon_SpokePool" "Linea_SpokePool" "ZkSync_SpokePool" "Ethereum_SpokePool" "WorldChain_SpokePool" "OP_SpokePool")
if [[ "$1" == "--overwrite" ]]; then
