...
CONTRACTS=("Universal_SpokePool" "Arbitrum_SpokePool" "Optimism_SpokePool" "Polygon_SpokePool" "Linea_SpokePool" "ZkSync_SpokePool" "Ethereum_SpokePool" "Blast_SpokePool" "Scroll_SpokePool" "PolygonZkEVM_SpokePool" "OP_SpokePool")
if [[ "$1" == "--overwrite" ]]; then
