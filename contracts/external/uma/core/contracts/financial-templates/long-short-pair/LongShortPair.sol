...
contract LongShortPair is Testable, Lockable {
    ...
    ) public nonReentrant returns (uint256 collateralReturned) {
     ...
     */
    function requestEarlyExpiration(
        uint64 _earlyExpirationTimestamp
    ) public nonReentrant notEarlyExpired preExpiration {
    ...
    function getPositionTokens(
        address sponsor
    ) public view nonReentrantView returns (uint256 longTokens, uint256 shortTokens) {
