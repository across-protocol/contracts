...
contract PreExpirationIdentifierTransformationFinancialProductLibrary is FinancialProductLibrary, Lockable {
     ...
     */
    function setFinancialProductTransformedIdentifier(
        address financialProduct,
     ...
     */
    function getTransformedIdentifierForFinancialProduct(
        address financialProduct
    ) public view nonReentrantView returns (bytes32) {
    ...
    function transformPriceIdentifier(
        bytes32 identifier,
        uint256 requestTime
    ) public view override nonReentrantView returns (bytes32) {
