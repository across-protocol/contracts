...
contract DesignatedVoting is Withdrawable {
     ...
     */
    constructor(address finderAddress, address ownerAddress, address voterAddress) {
    ...
    ) public onlyRoleHolder(uint256(Roles.Voter)) returns (FixedPoint.Unsigned memory) {
