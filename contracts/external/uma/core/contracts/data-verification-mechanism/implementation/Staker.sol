...
abstract contract Staker is StakerInterface, Ownable, Lockable, MultiCaller {
     ...
     */
    constructor(uint128 _emissionRate, uint64 _unstakeCoolDown, address _votingToken) {
    ...
    function _stakeTo(address from, address recipient, uint128 amount) internal {
    ...
    function _incrementPendingStake(address voter, uint32 roundId, uint128 amount) internal {
