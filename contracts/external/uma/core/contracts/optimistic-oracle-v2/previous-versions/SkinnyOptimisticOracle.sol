...
contract SkinnyOptimisticOracle is SkinnyOptimisticOracleInterface, Testable, Lockable {
     ...
     */
    constructor(uint256 _liveness, address _finderAddress, address _timerAddress) Testable(_timerAddress) {
    ...
    function proposePriceFor(
        ...
        Request memory proposedRequest = Request({
    ...
    function disputePriceFor(
        ...
        Request memory disputedRequest = Request({
    ...
    function _settle(
        ...
        Request memory settledRequest = Request({
            proposer: request.proposer,
            disputer: request.disputer,
            currency: request.currency,
