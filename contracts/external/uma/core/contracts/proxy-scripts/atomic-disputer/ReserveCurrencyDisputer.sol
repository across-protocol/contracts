...
contract ReserveCurrencyDisputer {
    ...
    function swapDispute(
        ...
        FixedPoint.Unsigned memory disputeBondAmount = liquidationData.lockedCollateral.mul(disputeBondPercentage).mul(
        ...
        FixedPoint.Unsigned memory collateralToBePurchased = subOrZero(
            totalCollateralRequired,
            getCollateralBalance(fc)
        );
    ...
    function subOrZero(
        FixedPoint.Unsigned memory a,
        FixedPoint.Unsigned memory b
