...
contract Mode_Adapter is CrossDomainEnabled, AdapterInterface, CircleCCTPAdapter {
    ...
    constructor(
        ...
        CircleCCTPAdapter(_l1Usdc, _cctpTokenMessenger, _cctpTokenMinter, CircleDomainIds.Ethereum) // CCTP is not enabled on this chain so Ethereum is a placeholder
    {
        L1_WETH = _l1Weth;
