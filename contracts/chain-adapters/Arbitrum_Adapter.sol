...
contract Arbitrum_Adapter is AdapterInterface {
    ...
    function relayTokens(
        ...
        // We don't use outboundTransferCustomRefund because in practice it seems to be crediting the `to`
        // address with the gas refund rather than the `l2RefundAddress`.
