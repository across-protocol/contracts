...
/**
 * @notice Contract containing logic to send messages from L1 to Ink. This is a clone of the Base/Mode adapter
...
contract Ink_Adapter is CrossDomainEnabled, AdapterInterface, CircleCCTPAdapter {
     ...
     * @param _crossDomainMessenger XDomainMessenger Ink system contract.
    ...
    /**
     * @notice Send cross-chain message to target on Ink.
     * @param target Contract on Ink that will receive message.
