...
library HyperCoreLib {
    ...
    function transferERC20EVMToCore(
        ...
        uint256 amountEVM,
        int8 decimalDiff
    ) public returns (uint256 amountEVMSent, uint64 amountCoreToReceive) {
     ...
     */
    function coreUserExists(address user) public view returns (bool) {
     ...
     */
    function tokenInfo(uint32 erc20CoreIndex) public view returns (TokenInfo memory) {
