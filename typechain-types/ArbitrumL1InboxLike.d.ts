...
interface ArbitrumL1InboxLikeInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [string, BigNumberish, BigNumberish, string, string, BigNumberish, BigNumberish, BytesLike]
  ): string;
...
export class ArbitrumL1InboxLike extends BaseContract {
