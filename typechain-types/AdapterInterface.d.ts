...
interface AdapterInterfaceInterface extends ethers.utils.Interface {
  functions: {
...
export class AdapterInterface extends BaseContract {
  ...
  interface: AdapterInterfaceInterface;
