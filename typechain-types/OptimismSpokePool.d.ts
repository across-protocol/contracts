...
interface OptimismSpokePoolInterface extends ethers.utils.Interface {
  functions: {
...
export type SetL1GasEvent = TypedEvent<[number] & { newL1Gas: number }>;
...
export class OptimismSpokePool extends BaseContract {
  ...
  interface: OptimismSpokePoolInterface;
  ...
  filters: {
    ...
    "SetL1Gas(uint32)"(newL1Gas?: BigNumberish | null): TypedEventFilter<[number], { newL1Gas: number }>;

    SetL1Gas(newL1Gas?: BigNumberish | null): TypedEventFilter<[number], { newL1Gas: number }>;
