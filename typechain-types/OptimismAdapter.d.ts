...
interface OptimismAdapterInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "l1StandardBridge", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "l1StandardBridge", data: BytesLike): Result;
...
export type L2GasLimitSetEvent = TypedEvent<[number] & { newGasLimit: number }>;
...
export class OptimismAdapter extends BaseContract {
  ...
  interface: OptimismAdapterInterface;
  ...
  filters: {
    ...
    "L2GasLimitSet(uint32)"(newGasLimit?: null): TypedEventFilter<[number], { newGasLimit: number }>;

    L2GasLimitSet(newGasLimit?: null): TypedEventFilter<[number], { newGasLimit: number }>;
