...
interface PolygonSpokePoolInterface extends ethers.utils.Interface {
  functions: {
...
export type PolygonTokensBridgedEvent = TypedEvent<
...
export type SetFxChildEvent = TypedEvent<[string] & { newFxChild: string }>;

export type SetHubPoolEvent = TypedEvent<[string] & { newHubPool: string }>;

export type SetPolygonTokenBridgerEvent = TypedEvent<[string] & { polygonTokenBridger: string }>;
...
export class PolygonSpokePool extends BaseContract {
  ...
  interface: PolygonSpokePoolInterface;
  ...
  filters: {
    ...
    "PolygonTokensBridged(address,address,uint256)"(
      ...
      amount?: null
    ): TypedEventFilter<[string, string, BigNumber], { token: string; receiver: string; amount: BigNumber }>;
    ...
    "SetFxChild(address)"(newFxChild?: string | null): TypedEventFilter<[string], { newFxChild: string }>;

    SetFxChild(newFxChild?: string | null): TypedEventFilter<[string], { newFxChild: string }>;
    ...
    "SetPolygonTokenBridger(address)"(
      polygonTokenBridger?: string | null
    ): TypedEventFilter<[string], { polygonTokenBridger: string }>;
