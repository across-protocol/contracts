...
// Copied from "@uma/core/contracts/common/implementation/AddressWhitelist.sol" but extends this repo's Lockable
// contract. This is because Forge tests complain if we import the @uma version of AddressWhitelist which extends
// the @uma version of Lockable, because it clashes with the Lockable contract defined in this repo imported by other
// contracts like HubPool.
contract MockAddressWhitelist is AddressWhitelistInterface, Ownable, Lockable {
    enum Status {
        None,
        In,
        Out
