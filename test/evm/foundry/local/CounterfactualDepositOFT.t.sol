...
contract CounterfactualOFTDepositTest is Test {
    ...
    function _leaf(address impl, bytes memory params) internal view returns (bytes32) {
        return keccak256(bytes.concat(keccak256(abi.encode(block.chainid, impl, keccak256(params)))));
    }
