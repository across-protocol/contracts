...
// 2. forge script script/chain-adapters/DeployUnichainAdapter.s.sol:DeployUnichainAdapter --rpc-url $NODE_URL_1 -vvvv
// 3. Verify the above works in simulation mode.
// 4. Deploy on mainnet by adding --broadcast --verify flags.
// 5. forge script script/chain-adapters/DeployUnichainAdapter.s.sol:DeployUnichainAdapter --rpc-url $NODE_URL_1 --broadcast --verify -vvvv
