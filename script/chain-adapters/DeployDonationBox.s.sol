...
// 2. forge script script/chain-adapters/DeployDonationBox.s.sol:DeployDonationBox --rpc-url $NODE_URL_1 -vvvv
// 3. Verify the above works in simulation mode.
// 4. Deploy by adding --broadcast --verify flags.
// 5. forge script script/chain-adapters/DeployDonationBox.s.sol:DeployDonationBox --rpc-url $NODE_URL_1 --broadcast --verify -vvvv
