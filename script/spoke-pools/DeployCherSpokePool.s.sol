...
import { Cher_SpokePool } from "../../contracts/spoke-pools/Cher_SpokePool.sol";
import { DeploymentUtils } from "../utils/DeploymentUtils.sol";

// How to run:
// 1. `source .env` where `.env` has MNEMONIC="x x x ... x"
// 2. forge script script/spoke-pools/DeployCherSpokePool.s.sol:DeployCherSpokePool --rpc-url $NODE_URL_1 -vvvv
// 3. Verify the above works in simulation mode.
// 4. Deploy with:
//        forge script script/spoke-pools/DeployCherSpokePool.s.sol:DeployCherSpokePool --rpc-url \
