...
// 2. forge script script/spoke-pools/DeployPolygonSpokePool.s.sol:DeployPolygonSpokePool --rpc-url polygon -vvvv
// 3. Verify the above works in simulation mode.
// 4. Deploy with: forge script script/spoke-pools/DeployPolygonSpokePool.s.sol:DeployPolygonSpokePool --rpc-url polygon --broadcast --verify
...
contract DeployPolygonSpokePool is Script, Test, DeploymentUtils {
    function run() external {
        ...
        // Fee cap of 68619 POL is roughly equivalent to $5K at current POL price of ~0.07302
        uint256 oftFeeCap = 69000 ether;
