...
// 2. forge script script/056DeployOPAdapter.s.sol:DeployOPAdapter --rpc-url $NODE_URL_1 -vvvv
...
contract DeployOPAdapter is Script, Test, Constants {
    function run() external {
        ...
        Constants.OpStackAddresses memory opStack = getOpStackAddresses(chainId, spokeChainId);
        ...
        console.log("OP Adapter deployed to:", address(adapter));
