...
/**
 * @title DeployZkstackAdapter
 * @notice Template for deploying any L1 adapter for a specific L2.
 * @dev Replace Zkstack with the specific L2 name (e.g., Arbitrum, Optimism).
 */
contract DeployZkstackAdapter is Script, ChainUtils {
    function run() external {
        ...
        console.log("Deploying Zkstack Adapter on chain %s", chainId);
        ...
        // Zkstack_Adapter adapter = new Zkstack_Adapter(
        //     specificBridgeAddress,
        //     weth,
        //     usdc,
        //     cctpTokenMessenger
        // );
        // console.log("Zkstack_Adapter deployed at: %s", address(adapter));
