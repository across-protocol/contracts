...
/**
 * @title DeployUnichainSpokePool
 * @notice Template for deploying any L2 SpokePool.
 * @dev Replace Unichain with the specific L2 name (e.g., Arbitrum, Optimism).
 */
contract DeployUnichainSpokePool is Script, ChainUtils {
    ...
    function run() external {
        ...
        address wrappedNativeToken = getUnichainWrappedNative(chainId);
        ...
        console.log("Deploying Unichain_SpokePool on chain %s", chainId);
    ...
    function getUnichainWrappedNative(uint256 chainId) internal pure returns (address) {
