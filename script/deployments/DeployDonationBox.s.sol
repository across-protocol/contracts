...
/**
 * @title DeployDonationBox
 * @notice Template for deploying utility contracts like Multicall, ERC1155, etc.
 * @dev Replace DonationBox with the specific name (e.g., Multicall3, ERC1155).
 */
contract DeployDonationBox is Script, ChainUtils {
    function run() external {
        ...
        console.log("Deploying DonationBox on chain %s", chainId);
        ...
        // DonationBox utility = new DonationBox(
        //     // Constructor parameters if any
        // );
        // console.log("DonationBox deployed at: %s", address(utility));
