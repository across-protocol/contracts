 ...
 */
contract DeployZksyncAdapter is Script, ChainUtils {
    function run() external {
        ...
        console.log("Deploying Zksync Adapter on chain %s", chainId);
        ...
        // Zksync_Adapter adapter = new Zksync_Adapter(
        //     specificBridgeAddress,
        //     weth,
        //     usdc,
        //     cctpTokenMessenger
        // );
        // console.log("Zksync_Adapter deployed at: %s", address(adapter));
