 ...
 */
contract DeployLiskAdapter is Script, ChainUtils {
    function run() external {
        ...
        console.log("Deploying Lisk Adapter on chain %s", chainId);
        ...
        // Lisk_Adapter adapter = new Lisk_Adapter(
        //     specificBridgeAddress,
        //     weth,
        //     usdc,
        //     cctpTokenMessenger
        // );
        // console.log("Lisk_Adapter deployed at: %s", address(adapter));
