 ...
 */
contract DeployLineaAdapter is Script, ChainUtils {
    function run() external {
        ...
        console.log("Deploying Linea Adapter on chain %s", chainId);
        ...
        // Linea_Adapter adapter = new Linea_Adapter(
        //     specificBridgeAddress,
        //     weth,
        //     usdc,
        //     cctpTokenMessenger
        // );
        // console.log("Linea_Adapter deployed at: %s", address(adapter));
