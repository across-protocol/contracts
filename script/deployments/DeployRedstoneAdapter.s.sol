 ...
 */
contract DeployRedstoneAdapter is Script, ChainUtils {
    function run() external {
        ...
        console.log("Deploying Redstone Adapter on chain %s", chainId);
        ...
        // Redstone_Adapter adapter = new Redstone_Adapter(
        //     specificBridgeAddress,
        //     weth,
        //     usdc,
        //     cctpTokenMessenger
        // );
        // console.log("Redstone_Adapter deployed at: %s", address(adapter));
