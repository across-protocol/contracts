 ...
 */
contract DeployAlephzeroAdapter is Script, ChainUtils {
    function run() external {
        ...
        console.log("Deploying Alephzero Adapter on chain %s", chainId);
        ...
        // Alephzero_Adapter adapter = new Alephzero_Adapter(
        //     specificBridgeAddress,
        //     weth,
        //     usdc,
        //     cctpTokenMessenger
        // );
        // console.log("Alephzero_Adapter deployed at: %s", address(adapter));
