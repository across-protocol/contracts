 ...
 */
contract DeployGenericAdapter is Script, ChainUtils {
    function run() external {
        ...
        console.log("Deploying Generic Adapter on chain %s", chainId);
        ...
        // Generic_Adapter adapter = new Generic_Adapter(
        //     specificBridgeAddress,
        //     weth,
        //     usdc,
        //     cctpTokenMessenger
        // );
        // console.log("Generic_Adapter deployed at: %s", address(adapter));
