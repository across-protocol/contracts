...
/**
 * @title DeployUtilityContract
 * @notice Template for deploying utility contracts like Multicall, ERC1155, etc.
 * @dev Replace UtilityContract with the specific name (e.g., Multicall3, ERC1155).
 */
contract DeployUtilityContract is Script, ChainUtils {
    function run() external {
        ...
        console.log("Deploying UtilityContract on chain %s", chainId);
        ...
        // UtilityContract utility = new UtilityContract(
        //     // Constructor parameters if any
        // );
        // console.log("UtilityContract deployed at: %s", address(utility));
