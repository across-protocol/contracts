 ...
 */
contract DeployBobaAdapter is Script, ChainUtils {
    function run() external {
        ...
        console.log("Deploying Boba Adapter on chain %s", chainId);
        ...
        // Boba_Adapter adapter = new Boba_Adapter(
        //     specificBridgeAddress,
        //     weth,
        //     usdc,
        //     cctpTokenMessenger
        // );
        // console.log("Boba_Adapter deployed at: %s", address(adapter));
