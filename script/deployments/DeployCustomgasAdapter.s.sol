...
/**
 * @title DeployCustomgasAdapter
 * @notice Template for deploying any L1 adapter for a specific L2.
 * @dev Replace Customgas with the specific L2 name (e.g., Arbitrum, Optimism).
 */
contract DeployCustomgasAdapter is Script, ChainUtils {
    function run() external {
        ...
        console.log("Deploying Customgas Adapter on chain %s", chainId);
        ...
        // Customgas_Adapter adapter = new Customgas_Adapter(
        //     specificBridgeAddress,
        //     weth,
        //     usdc,
        //     cctpTokenMessenger
        // );
        // console.log("Customgas_Adapter deployed at: %s", address(adapter));
