...
/**
 * @title DeployLineaSpokePool
 * @notice Template for deploying any L2 SpokePool.
 * @dev Replace Linea with the specific L2 name (e.g., Arbitrum, Optimism).
 */
contract DeployLineaSpokePool is Script, ChainUtils {
    ...
    function run() external {
        ...
        address wrappedNativeToken = getLineaWrappedNative(chainId);
        ...
        console.log("Deploying Linea_SpokePool on chain %s", chainId);
    ...
    function getLineaWrappedNative(uint256 chainId) internal pure returns (address) {
