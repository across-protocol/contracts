 ...
 */
contract DeployUnichainAdapter is Script, ChainUtils {
    function run() external {
        ...
        console.log("Deploying Unichain Adapter on chain %s", chainId);
        ...
        // Unichain_Adapter adapter = new Unichain_Adapter(
        //     specificBridgeAddress,
        //     weth,
        //     usdc,
        //     cctpTokenMessenger
        // );
        // console.log("Unichain_Adapter deployed at: %s", address(adapter));
