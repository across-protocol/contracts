 ...
 */
contract DeployWorldchainAdapter is Script, ChainUtils {
    function run() external {
        ...
        console.log("Deploying Worldchain Adapter on chain %s", chainId);
        ...
        // Worldchain_Adapter adapter = new Worldchain_Adapter(
        //     specificBridgeAddress,
        //     weth,
        //     usdc,
        //     cctpTokenMessenger
        // );
        // console.log("Worldchain_Adapter deployed at: %s", address(adapter));
