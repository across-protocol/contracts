 ...
 */
contract DeployEvmAdapter is Script, ChainUtils {
    function run() external {
        ...
        console.log("Deploying Evm Adapter on chain %s", chainId);
        ...
        // Evm_Adapter adapter = new Evm_Adapter(
        //     specificBridgeAddress,
        //     weth,
        //     usdc,
        //     cctpTokenMessenger
        // );
        // console.log("Evm_Adapter deployed at: %s", address(adapter));
