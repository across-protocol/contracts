...
/**
 * @title DeployOpAdapter
 * @notice Template for deploying any L1 adapter for a specific L2.
 * @dev Replace Op with the specific L2 name (e.g., Arbitrum, Optimism).
 */
contract DeployOpAdapter is Script, ChainUtils {
    function run() external {
        ...
        console.log("Deploying Op Adapter on chain %s", chainId);
        ...
        // Op_Adapter adapter = new Op_Adapter(
        //     specificBridgeAddress,
        //     weth,
        //     usdc,
        //     cctpTokenMessenger
        // );
        // console.log("Op_Adapter deployed at: %s", address(adapter));
