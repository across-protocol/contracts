...
/**
 * @title DeployRescueAdapter
 * @notice Template for deploying any L1 adapter for a specific L2.
 * @dev Replace Rescue with the specific L2 name (e.g., Arbitrum, Optimism).
 */
contract DeployRescueAdapter is Script, ChainUtils {
    function run() external {
        ...
        console.log("Deploying Rescue Adapter on chain %s", chainId);
        ...
        // Rescue_Adapter adapter = new Rescue_Adapter(
        //     specificBridgeAddress,
        //     weth,
        //     usdc,
        //     cctpTokenMessenger
        // );
        // console.log("Rescue_Adapter deployed at: %s", address(adapter));
