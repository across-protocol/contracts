 ...
 */
contract DeployZoraAdapter is Script, ChainUtils {
    function run() external {
        ...
        console.log("Deploying Zora Adapter on chain %s", chainId);
        ...
        // Zora_Adapter adapter = new Zora_Adapter(
        //     specificBridgeAddress,
        //     weth,
        //     usdc,
        //     cctpTokenMessenger
        // );
        // console.log("Zora_Adapter deployed at: %s", address(adapter));
