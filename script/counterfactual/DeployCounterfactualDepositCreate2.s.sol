...
// 2. forge script script/counterfactual/DeployCounterfactualDepositCreate2.s.sol:DeployCounterfactualDepositCreate2 --rpc-url $NODE_URL -vvvv
// 3. Verify simulation works
// 4. Deploy: append --broadcast --verify to the command above
contract DeployCounterfactualDepositCreate2 is Create2DeployUtils, Test {
