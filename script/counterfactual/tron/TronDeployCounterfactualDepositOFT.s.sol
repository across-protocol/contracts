...
// 3. forge script script/counterfactual/tron/TronDeployCounterfactualDepositOFT.s.sol \
//      --sig "run(uint256,address,uint32)" <chainId> <oftSrcPeriphery> <srcEid>

contract TronDeployCounterfactualDepositOFT is Script {
    function run(uint256 chainId, address oftSrcPeriphery, uint32 srcEid) external {
        ...
        bytes memory encodedArgs = abi.encode(oftSrcPeriphery, srcEid);
        ...
        console.log("Deployed CounterfactualDepositOFT:", deployed);
    }
}
