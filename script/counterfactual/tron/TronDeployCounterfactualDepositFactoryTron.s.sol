...
// 3. forge script script/counterfactual/tron/TronDeployCounterfactualDepositFactoryTron.s.sol \
//      --sig "run(uint256)" <chainId>

contract TronDeployCounterfactualDepositFactoryTron is Script {
    function run(uint256 chainId) external {
        ...
        console.log("Deployed CounterfactualDepositFactoryTron:", deployed);
    }
}
