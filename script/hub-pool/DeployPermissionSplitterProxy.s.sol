...
// 2. forge script script/hub-pool/DeployPermissionSplitterProxy.s.sol:DeployPermissionSplitterProxy --rpc-url $NODE_URL_1-vvvv
// 3. Verify the above works in simulation mode.
// 4. Deploy on mainnet by adding --broadcast --verify flags.
// 5. forge script script/hub-pool/DeployPermissionSplitterProxy.s.sol:DeployPermissionSplitterProxy --rpc-url $NODE_URL_1 --broadcast --verify -vvvv
