...
echo "yarn foundry cast call $DST_PERIPHERY \"DEFAULT_ADMIN_ROLE()(bytes32)\" --rpc-url $RPC_URL"
echo ""
echo "# Check if deployer has DEFAULT_ADMIN_ROLE (replace <DEPLOYER> and <ROLE>):"
echo "yarn foundry cast call $DST_PERIPHERY \"hasRole(bytes32,address)(bool)\" <ROLE> <DEPLOYER> --rpc-url $RPC_URL"
echo ""
echo "# Set core token info:"
echo "yarn foundry cast send $DST_PERIPHERY \\"
