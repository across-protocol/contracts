...
[`hypercore-tokens.json`](script/mintburn/hypercore-tokens.json) lives alongside these scripts and is read by [`ReadHCoreTokenInfoUtil.s.sol`](script/mintburn/ReadHCoreTokenInfoUtil.s.sol) for HyperCore token setup.
