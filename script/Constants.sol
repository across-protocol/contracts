...
contract Constants {
    ...
    // Token addresses
    WETH9Interface constant WRAPPED_NATIVE_TOKEN_MAINNET = WETH9Interface(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2);
    WETH9Interface constant WRAPPED_NATIVE_TOKEN_SEPOLIA = WETH9Interface(0x7b79995e5f793A07Bc00c21412e50Ecae098E7f9);
    WETH9Interface constant WRAPPED_NATIVE_TOKEN_ARBITRUM = WETH9Interface(0x82aF49447D8a07e3bd95BD0d56f35241523fBab1);
    WETH9Interface constant WRAPPED_NATIVE_TOKEN_ARBITRUM_SEPOLIA =
        WETH9Interface(0x980B62Da83eFf3D4576C647993b0c1D7faf17c73);
    WETH9Interface constant WRAPPED_NATIVE_TOKEN_BSC = WETH9Interface(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c); // WBNB acts as WETH on BSC
    WETH9Interface constant WRAPPED_NATIVE_TOKEN_POLYGON = WETH9Interface(0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270);
    WETH9Interface constant WRAPPED_NATIVE_TOKEN_POLYGON_AMOY =
        WETH9Interface(0xA5733b3A8e62A8faF43b0376d5fAF46E89B3033E);
    WETH9Interface constant WRAPPED_NATIVE_TOKEN_ZK_SYNC = WETH9Interface(0x5AEa5775959fBC2557Cc8789bC1bf90A239D9a91);
    WETH9Interface constant WRAPPED_NATIVE_TOKEN_OPTIMISM = WETH9Interface(0x4200000000000000000000000000000000000006);
    ...
    WETH9Interface constant WRAPPED_NATIVE_TOKEN_BASE_SEPOLIA =
        WETH9Interface(0x999B45BB215209e567FaF486515af43b8353e393);
    WETH9Interface constant WRAPPED_NATIVE_TOKEN_LENS = WETH9Interface(0x4200000000000000000000000000000000000006);
    WETH9Interface constant WRAPPED_NATIVE_TOKEN_LENS_TESTNET =
        WETH9Interface(0xaA91D645D7a6C1aeaa5988e0547267B77d33fe16);
    WETH9Interface constant WRAPPED_NATIVE_TOKEN_LINEA = WETH9Interface(0xe5D7C2a44FfDDf6b295A15c148167daaAf5Cf34f);
    WETH9Interface constant WRAPPED_NATIVE_TOKEN_LINEA_SEPOLIA =
        WETH9Interface(0x10253594A832f967994b44f33411940533302ACb);
    WETH9Interface constant WRAPPED_NATIVE_TOKEN_SCROLL_SEPOLIA =
        WETH9Interface(0x5300000000000000000000000000000000000004);
    WETH9Interface constant WRAPPED_NATIVE_TOKEN_SCROLL = WETH9Interface(0x5300000000000000000000000000000000000004);
    WETH9Interface constant WRAPPED_NATIVE_TOKEN_UNICHAIN = WETH9Interface(0x4200000000000000000000000000000000000006);
    WETH9Interface constant WRAPPED_NATIVE_TOKEN_UNICHAIN_SEPOLIA =
        WETH9Interface(0x4200000000000000000000000000000000000006);
    WETH9Interface constant WRAPPED_NATIVE_TOKEN_ALEPH_ZERO =
        WETH9Interface(0xB3f0eE446723f4258862D949B4c9688e7e7d35d3); // Assuming bridged WETH
    WETH9Interface constant WRAPPED_NATIVE_TOKEN_BLAST = WETH9Interface(0x4300000000000000000000000000000000000004);
    WETH9Interface constant WRAPPED_NATIVE_TOKEN_BLAST_SEPOLIA =
        WETH9Interface(0x4200000000000000000000000000000000000023);
    WETH9Interface constant WRAPPED_NATIVE_TOKEN_BOBA = WETH9Interface(0xDeadDeAddeAddEAddeadDEaDDEAdDeaDDeAD0000);
    ...
    WETH9Interface constant WRAPPED_NATIVE_TOKEN_LISK_SEPOLIA =
        WETH9Interface(0x4200000000000000000000000000000000000006);
    ...
    WETH9Interface constant WRAPPED_NATIVE_TOKEN_WORLD_CHAIN =
        WETH9Interface(0x4200000000000000000000000000000000000006);
    WETH9Interface constant WRAPPED_NATIVE_TOKEN_ZORA = WETH9Interface(0x4200000000000000000000000000000000000006);
    ...
    function getWrappedNativeToken(uint256 chainId) public pure returns (WETH9Interface) {
        if (chainId == MAINNET) return WRAPPED_NATIVE_TOKEN_MAINNET;
        if (chainId == SEPOLIA) return WRAPPED_NATIVE_TOKEN_SEPOLIA;
        if (chainId == ARBITRUM) return WRAPPED_NATIVE_TOKEN_ARBITRUM;
        if (chainId == ARBITRUM_SEPOLIA) return WRAPPED_NATIVE_TOKEN_ARBITRUM_SEPOLIA;
        if (chainId == BSC) return WRAPPED_NATIVE_TOKEN_BSC;
        if (chainId == POLYGON) return WRAPPED_NATIVE_TOKEN_POLYGON;
        if (chainId == POLYGON_AMOY) return WRAPPED_NATIVE_TOKEN_POLYGON_AMOY;
        if (chainId == ZK_SYNC) return WRAPPED_NATIVE_TOKEN_ZK_SYNC;
        if (chainId == OPTIMISM) return WRAPPED_NATIVE_TOKEN_OPTIMISM;
        if (chainId == OPTIMISM_SEPOLIA) return WRAPPED_NATIVE_TOKEN_OPTIMISM_SEPOLIA;
        if (chainId == BASE) return WRAPPED_NATIVE_TOKEN_BASE;
        if (chainId == BASE_SEPOLIA) return WRAPPED_NATIVE_TOKEN_BASE_SEPOLIA;
        if (chainId == LENS) return WRAPPED_NATIVE_TOKEN_LENS;
        if (chainId == LENS_TESTNET) return WRAPPED_NATIVE_TOKEN_LENS_TESTNET;
        if (chainId == LINEA) return WRAPPED_NATIVE_TOKEN_LINEA;
        if (chainId == LINEA_SEPOLIA) return WRAPPED_NATIVE_TOKEN_LINEA_SEPOLIA;
        if (chainId == SCROLL_SEPOLIA) return WRAPPED_NATIVE_TOKEN_SCROLL_SEPOLIA;
        if (chainId == SCROLL) return WRAPPED_NATIVE_TOKEN_SCROLL;
        if (chainId == UNICHAIN) return WRAPPED_NATIVE_TOKEN_UNICHAIN;
        if (chainId == UNICHAIN_SEPOLIA) return WRAPPED_NATIVE_TOKEN_UNICHAIN_SEPOLIA;
        if (chainId == ALEPH_ZERO) return WRAPPED_NATIVE_TOKEN_ALEPH_ZERO;
        if (chainId == BLAST) return WRAPPED_NATIVE_TOKEN_BLAST;
        if (chainId == BLAST_SEPOLIA) return WRAPPED_NATIVE_TOKEN_BLAST_SEPOLIA;
        if (chainId == BOBA) return WRAPPED_NATIVE_TOKEN_BOBA;
        if (chainId == INK) return WRAPPED_NATIVE_TOKEN_INK;
        if (chainId == LISK) return WRAPPED_NATIVE_TOKEN_LISK;
        if (chainId == LISK_SEPOLIA) return WRAPPED_NATIVE_TOKEN_LISK_SEPOLIA;
        if (chainId == MODE) return WRAPPED_NATIVE_TOKEN_MODE;
        if (chainId == MODE_SEPOLIA) return WRAPPED_NATIVE_TOKEN_MODE_SEPOLIA;
        if (chainId == REDSTONE) return WRAPPED_NATIVE_TOKEN_REDSTONE;
        if (chainId == SONEIUM) return WRAPPED_NATIVE_TOKEN_SONEIUM;
        if (chainId == WORLD_CHAIN) return WRAPPED_NATIVE_TOKEN_WORLD_CHAIN;
        if (chainId == ZORA) return WRAPPED_NATIVE_TOKEN_ZORA;
        revert("Unsupported chain ID");
    }
}
