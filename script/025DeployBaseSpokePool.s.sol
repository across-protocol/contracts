...
// 2. forge script script/025DeployBaseSpokePool.s.sol:DeployBaseSpokePool --rpc-url $NODE_URL_8453 -vvvv
// 3. Verify the above works in simulation mode.
// 4. Deploy with: forge script script/025DeployBaseSpokePool.s.sol:DeployBaseSpokePool --rpc-url $NODE_URL_8453 --broadcast --verify

contract DeployBaseSpokePool is Script, Test, DeploymentUtils {
    function run() external {
        ...
        console.log("Base_SpokePool proxy deployed to:", result.proxy);
        console.log("Base_SpokePool implementation deployed to:", result.implementation);
