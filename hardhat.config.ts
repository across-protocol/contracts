...
const config: HardhatUserConfig = {
  solidity: {
    ...
    overrides: {
      "contracts/hub-pool/HubPool.sol": LARGE_CONTRACT_COMPILER_SETTINGS,
      "contracts/spoke-pools/Linea_SpokePool.sol": LARGE_CONTRACT_COMPILER_SETTINGS,
      "contracts/spoke-pools/Universal_SpokePool.sol": LARGE_CONTRACT_COMPILER_SETTINGS,
      "contracts/spoke-pools/Arbitrum_SpokePool.sol": LARGE_CONTRACT_COMPILER_SETTINGS,
      "contracts/spoke-pools/Scroll_SpokePool.sol": LARGE_CONTRACT_COMPILER_SETTINGS,
      "contracts/spoke-pools/Lisk_SpokePool.sol": LARGE_CONTRACT_COMPILER_SETTINGS,
      "contracts/spoke-pools/OP_SpokePool.sol": LARGE_CONTRACT_COMPILER_SETTINGS,
      "contracts/spoke-pools/Optimism_SpokePool.sol": LARGE_CONTRACT_COMPILER_SETTINGS,
      "contracts/spoke-pools/WorldChain_SpokePool.sol": LARGE_CONTRACT_COMPILER_SETTINGS,
      "contracts/spoke-pools/Ink_SpokePool.sol": LARGE_CONTRACT_COMPILER_SETTINGS,
      "contracts/spoke-pools/Cher_SpokePool.sol": LARGE_CONTRACT_COMPILER_SETTINGS,
      "contracts/spoke-pools/Blast_SpokePool.sol": LARGEST_CONTRACT_COMPILER_SETTINGS,
